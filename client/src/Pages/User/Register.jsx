        ...
        <div className="bg-white rounded-2xl shadow-2xl flex w-2/3 max-w-4xl">
          <div className='w-3/5 p-5'>
            ...
            <div className="py-10 text-center">
              <h2 className='text-3xl font-bold text-green-500 mb-2'> Register Your Account </h2>
              ...
              <div className='flex flex-col items-center'>
                <form onSubmit={registerForm} className='w-full'>
                  ...
                  <div className='mx-auto w-[75%]'>
                    ...
                    <button className='border-2 text-green-500 border-green-500 rounded-full px-12 py-2 inline-block font-semibold hover:bg-green-500 hover:text-white'>Register</button>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div className='w-2/5 bg-green-500 text-white rounded-tr-2xl rounded-br-2xl py-36 px-12 text-center'>
            ...
            <NavLink to='/login'><button className='border-2 text-white border-white rounded-full px-12 py-2 inline-block font-semibold hover:bg-white hover:text-green-500'>Login</button></NavLink>
